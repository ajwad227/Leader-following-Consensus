...
(cl:in-package minilab_navigation-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name minilab_navigation-msg:<Command> is deprecated: use minilab_navigation-msg:Command instead.")))

(cl:ensure-generic-function 'commanded_velocity-val :lambda-list '(m))
(cl:defmethod commanded_velocity-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader minilab_navigation-msg:commanded_velocity-val is deprecated.  Use minilab_navigation-msg:commanded_velocity instead.")
